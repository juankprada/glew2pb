...
glAccum(op_.i,value_.f)
glAlphaFunc(func_.i,ref_.f)
glAreTexturesResident.b(n_.i,textures_.i,residences_.b)
glArrayElement(i_.i)
glBegin(mode_.i)
glBindTexture(target_.i,texture_.i)
glBitmap(width_.i,height_.i,xorig_.f,yorig_.f,xmove_.f,ymove_.f,bitmap_.s)
glBlendFunc(sfactor_.i,dfactor_.i)
glCallList(list_.i)
glCallLists(n_.i,type_.i,lists_.b)
glClear(mask_.i)
glClearAccum(red_.f,green_.f,blue_.f,alpha_.f)
glClearColor(red_.f,green_.f,blue_.f,alpha_.f)
glClearDepth(depth_.d)
glClearIndex(c_.f)
glClearStencil(s_.i)
glClipPlane(plane_.i,equation_.d)
glColor3b(red_.s,green_.s,blue_.s)
glColor3bv(v_.s)
glColor3d(red_.d,green_.d,blue_.d)
glColor3dv(v_.d)
glColor3f(red_.f,green_.f,blue_.f)
glColor3fv(v_.f)
glColor3i(red_.i,green_.i,blue_.i)
glColor3iv(v_.i)
glColor3s(red_.i,green_.i,blue_.i)
glColor3sv(v_.i)
glColor3ub(red_.s,green_.s,blue_.s)
glColor3ubv(v_.s)
glColor3ui(red_.i,green_.i,blue_.i)
glColor3uiv(v_.i)
glColor3us(red_.i,green_.i,blue_.i)
glColor3usv(v_.i)
glColor4b(red_.s,green_.s,blue_.s,alpha_.s)
glColor4bv(v_.s)
glColor4d(red_.d,green_.d,blue_.d,alpha_.d)
glColor4dv(v_.d)
glColor4f(red_.f,green_.f,blue_.f,alpha_.f)
glColor4fv(v_.f)
glColor4i(red_.i,green_.i,blue_.i,alpha_.i)
glColor4iv(v_.i)
glColor4s(red_.i,green_.i,blue_.i,alpha_.i)
glColor4sv(v_.i)
glColor4ub(red_.s,green_.s,blue_.s,alpha_.s)
glColor4ubv(v_.s)
glColor4ui(red_.i,green_.i,blue_.i,alpha_.i)
glColor4uiv(v_.i)
glColor4us(red_.i,green_.i,blue_.i,alpha_.i)
glColor4usv(v_.i)
glColorMask(red_.b,green_.b,blue_.b,alpha_.b)
glColorMaterial(face_.i,mode_.i)
glColorPointer(size_.i,type_.i,stride_.i,pointer_.b)
glCopyPixels(x_.i,y_.i,width_.i,height_.i,type_.i)
glCopyTexImage1D(target_.i,level_.i,internalFormat_.i,x_.i,y_.i,width_.i,border_.i)
glCopyTexImage2D(target_.i,level_.i,internalFormat_.i,x_.i,y_.i,width_.i,height_.i,border_.i)
glCopyTexSubImage1D(target_.i,level_.i,xoffset_.i,x_.i,y_.i,width_.i)
glCopyTexSubImage2D(target_.i,level_.i,xoffset_.i,yoffset_.i,x_.i,y_.i,width_.i,height_.i)
glCullFace(mode_.i)
glDeleteLists(list_.i,range_.i)
glDeleteTextures(n_.i,textures_.i)
glDepthFunc(func_.i)
glDepthMask(flag_.b)
glDepthRange(zNear_.d,zFar_.d)
glDisable(cap_.i)
glDisableClientState(array_.i)
glDrawArrays(mode_.i,first_.i,count_.i)
glDrawBuffer(mode_.i)
glDrawElements(mode_.i,count_.i,type_.i,indices_.b)
glDrawPixels(width_.i,height_.i,format_.i,type_.i,pixels_.b)
glEdgeFlag(flag_.b)
glEdgeFlagPointer(stride_.i,pointer_.b)
glEdgeFlagv(flag_.b)
glEnable(cap_.i)
glEnableClientState(array_.i)
glEnd()
glEndList()
glEvalCoord1d(u_.d)
glEvalCoord1dv(u_.d)
glEvalCoord1f(u_.f)
glEvalCoord1fv(u_.f)
glEvalCoord2d(u_.d,v_.d)
glEvalCoord2dv(u_.d)
glEvalCoord2f(u_.f,v_.f)
glEvalCoord2fv(u_.f)
glEvalMesh1(mode_.i,i1_.i,i2_.i)
glEvalMesh2(mode_.i,i1_.i,i2_.i,j1_.i,j2_.i)
glEvalPoint1(i_.i)
glEvalPoint2(i_.i,j_.i)
glFeedbackBuffer(size_.i,type_.i,buffer_.f)
glFinish()
glFlush()
glFogf(pname_.i,param_.f)
glFogfv(pname_.i,params_.f)
glFogi(pname_.i,param_.i)
glFogiv(pname_.i,params_.i)
glFrontFace(mode_.i)
glFrustum(left_.d,right_.d,bottom_.d,top_.d,zNear_.d,zFar_.d)
glGenLists.i(range_.i)
glGenTextures(n_.i,textures_.i)
glGetBooleanv(pname_.i,params_.b)
glGetClipPlane(plane_.i,equation_.d)
glGetDoublev(pname_.i,params_.d)
glGetError.i()
glGetFloatv(pname_.i,params_.f)
glGetIntegerv(pname_.i,params_.i)
glGetLightfv(light_.i,pname_.i,params_.f)
glGetLightiv(light_.i,pname_.i,params_.i)
glGetMapdv(target_.i,query_.i,v_.d)
glGetMapfv(target_.i,query_.i,v_.f)
glGetMapiv(target_.i,query_.i,v_.i)
glGetMaterialfv(face_.i,pname_.i,params_.f)
glGetMaterialiv(face_.i,pname_.i,params_.i)
glGetPixelMapfv(map_.i,values_.f)
glGetPixelMapuiv(map_.i,values_.i)
glGetPixelMapusv(map_.i,values_.i)
glGetPointerv(pname_.i,params_.b)
glGetPolygonStipple(mask_.s)
glGetString.s(name_.i)
glGetTexEnvfv(target_.i,pname_.i,params_.f)
glGetTexEnviv(target_.i,pname_.i,params_.i)
glGetTexGendv(coord_.i,pname_.i,params_.d)
glGetTexGenfv(coord_.i,pname_.i,params_.f)
glGetTexGeniv(coord_.i,pname_.i,params_.i)
glGetTexImage(target_.i,level_.i,format_.i,type_.i,pixels_.b)
glGetTexLevelParameterfv(target_.i,level_.i,pname_.i,params_.f)
glGetTexLevelParameteriv(target_.i,level_.i,pname_.i,params_.i)
glGetTexParameterfv(target_.i,pname_.i,params_.f)
glGetTexParameteriv(target_.i,pname_.i,params_.i)
glHint(target_.i,mode_.i)
glIndexMask(mask_.i)
glIndexPointer(type_.i,stride_.i,pointer_.b)
glIndexd(c_.d)
glIndexdv(c_.d)
glIndexf(c_.f)
glIndexfv(c_.f)
...
glIndexubv(c_.s)
glInitNames()
glInterleavedArrays(format_.i,stride_.i,pointer_.b)
glIsEnabled.b(cap_.i)
glIsList.b(list_.i)
glIsTexture.b(texture_.i)
glLightModelf(pname_.i,param_.f)
glLightModelfv(pname_.i,params_.f)
glLightModeli(pname_.i,param_.i)
glLightModeliv(pname_.i,params_.i)
glLightf(light_.i,pname_.i,param_.f)
glLightfv(light_.i,pname_.i,params_.f)
glLighti(light_.i,pname_.i,param_.i)
glLightiv(light_.i,pname_.i,params_.i)
glLineStipple(factor_.i,pattern_.i)
glLineWidth(width_.f)
glListBase(base_.i)
glLoadIdentity()
glLoadMatrixd(m_.d)
glLoadMatrixf(m_.f)
glLoadName(name_.i)
glLogicOp(opcode_.i)
glMap1d(target_.i,u1_.d,u2_.d,stride_.i,order_.i,points_.d)
glMap1f(target_.i,u1_.f,u2_.f,stride_.i,order_.i,points_.f)
glMap2d(target_.i,u1_.d,u2_.d,ustride_.i,uorder_.i,v1_.d,v2_.d,vstride_.i,vorder_.i,points_.d)
glMap2f(target_.i,u1_.f,u2_.f,ustride_.i,uorder_.i,v1_.f,v2_.f,vstride_.i,vorder_.i,points_.f)
glMapGrid1d(un_.i,u1_.d,u2_.d)
glMapGrid1f(un_.i,u1_.f,u2_.f)
glMapGrid2d(un_.i,u1_.d,u2_.d,vn_.i,v1_.d,v2_.d)
glMapGrid2f(un_.i,u1_.f,u2_.f,vn_.i,v1_.f,v2_.f)
glMaterialf(face_.i,pname_.i,param_.f)
glMaterialfv(face_.i,pname_.i,params_.f)
glMateriali(face_.i,pname_.i,param_.i)
glMaterialiv(face_.i,pname_.i,params_.i)
glMatrixMode(mode_.i)
glMultMatrixd(m_.d)
glMultMatrixf(m_.f)
glNewList(list_.i,mode_.i)
glNormal3b(nx_.s,ny_.s,nz_.s)
glNormal3bv(v_.s)
glNormal3d(nx_.d,ny_.d,nz_.d)
glNormal3dv(v_.d)
glNormal3f(nx_.f,ny_.f,nz_.f)
glNormal3fv(v_.f)
glNormal3i(nx_.i,ny_.i,nz_.i)
glNormal3iv(v_.i)
glNormal3s(nx_.i,ny_.i,nz_.i)
glNormal3sv(v_.i)
glNormalPointer(type_.i,stride_.i,pointer_.b)
glOrtho(left_.d,right_.d,bottom_.d,top_.d,zNear_.d,zFar_.d)
glPassThrough(token_.f)
glPixelMapfv(map_.i,mapsize_.i,values_.f)
glPixelMapuiv(map_.i,mapsize_.i,values_.i)
glPixelMapusv(map_.i,mapsize_.i,values_.i)
glPixelStoref(pname_.i,param_.f)
glPixelStorei(pname_.i,param_.i)
glPixelTransferf(pname_.i,param_.f)
glPixelTransferi(pname_.i,param_.i)
glPixelZoom(xfactor_.f,yfactor_.f)
glPointSize(size_.f)
glPolygonMode(face_.i,mode_.i)
glPolygonOffset(factor_.f,units_.f)
glPolygonStipple(mask_.s)
glPopAttrib()
glPopClientAttrib()
glPopMatrix()
glPopName()
glPrioritizeTextures(n_.i,textures_.i,priorities_.f)
glPushAttrib(mask_.i)
glPushClientAttrib(mask_.i)
glPushMatrix()
glPushName(name_.i)
glRasterPos2d(x_.d,y_.d)
glRasterPos2dv(v_.d)
glRasterPos2f(x_.f,y_.f)
glRasterPos2fv(v_.f)
glRasterPos2i(x_.i,y_.i)
glRasterPos2iv(v_.i)
glRasterPos2s(x_.i,y_.i)
glRasterPos2sv(v_.i)
glRasterPos3d(x_.d,y_.d,z_.d)
glRasterPos3dv(v_.d)
glRasterPos3f(x_.f,y_.f,z_.f)
glRasterPos3fv(v_.f)
glRasterPos3i(x_.i,y_.i,z_.i)
glRasterPos3iv(v_.i)
glRasterPos3s(x_.i,y_.i,z_.i)
glRasterPos3sv(v_.i)
glRasterPos4d(x_.d,y_.d,z_.d,w_.d)
glRasterPos4dv(v_.d)
glRasterPos4f(x_.f,y_.f,z_.f,w_.f)
glRasterPos4fv(v_.f)
glRasterPos4i(x_.i,y_.i,z_.i,w_.i)
glRasterPos4iv(v_.i)
glRasterPos4s(x_.i,y_.i,z_.i,w_.i)
glRasterPos4sv(v_.i)
glReadBuffer(mode_.i)
glReadPixels(x_.i,y_.i,width_.i,height_.i,format_.i,type_.i,pixels_.b)
glRectd(x1_.d,y1_.d,x2_.d,y2_.d)
glRectdv(v1_.d,v2_.d)
glRectf(x1_.f,y1_.f,x2_.f,y2_.f)
glRectfv(v1_.f,v2_.f)
glRecti(x1_.i,y1_.i,x2_.i,y2_.i)
glRectiv(v1_.i,v2_.i)
glRects(x1_.i,y1_.i,x2_.i,y2_.i)
glRectsv(v1_.i,v2_.i)
glRenderMode.i(mode_.i)
glRotated(angle_.d,x_.d,y_.d,z_.d)
glRotatef(angle_.f,x_.f,y_.f,z_.f)
glScaled(x_.d,y_.d,z_.d)
glScalef(x_.f,y_.f,z_.f)
glScissor(x_.i,y_.i,width_.i,height_.i)
glSelectBuffer(size_.i,buffer_.i)
glShadeModel(mode_.i)
glStencilFunc(func_.i,ref_.i,mask_.i)
glStencilMask(mask_.i)
glStencilOp(fail_.i,zfail_.i,zpass_.i)
glTexCoord1d(s_.d)
glTexCoord1dv(v_.d)
glTexCoord1f(s_.f)
glTexCoord1fv(v_.f)
...
glTexCoord1s(s_.i)
glTexCoord1sv(v_.i)
glTexCoord2d(s_.d,t_.d)
glTexCoord2dv(v_.d)
glTexCoord2f(s_.f,t_.f)
glTexCoord2fv(v_.f)
glTexCoord2i(s_.i,t_.i)
glTexCoord2iv(v_.i)
glTexCoord2s(s_.i,t_.i)
glTexCoord2sv(v_.i)
glTexCoord3d(s_.d,t_.d,r_.d)
glTexCoord3dv(v_.d)
glTexCoord3f(s_.f,t_.f,r_.f)
glTexCoord3fv(v_.f)
glTexCoord3i(s_.i,t_.i,r_.i)
glTexCoord3iv(v_.i)
glTexCoord3s(s_.i,t_.i,r_.i)
glTexCoord3sv(v_.i)
glTexCoord4d(s_.d,t_.d,r_.d,q_.d)
glTexCoord4dv(v_.d)
glTexCoord4f(s_.f,t_.f,r_.f,q_.f)
glTexCoord4fv(v_.f)
glTexCoord4i(s_.i,t_.i,r_.i,q_.i)
glTexCoord4iv(v_.i)
glTexCoord4s(s_.i,t_.i,r_.i,q_.i)
glTexCoord4sv(v_.i)
glTexCoordPointer(size_.i,type_.i,stride_.i,pointer_.b)
glTexEnvf(target_.i,pname_.i,param_.f)
glTexEnvfv(target_.i,pname_.i,params_.f)
glTexEnvi(target_.i,pname_.i,param_.i)
glTexEnviv(target_.i,pname_.i,params_.i)
glTexGend(coord_.i,pname_.i,param_.d)
glTexGendv(coord_.i,pname_.i,params_.d)
glTexGenf(coord_.i,pname_.i,param_.f)
glTexGenfv(coord_.i,pname_.i,params_.f)
glTexGeni(coord_.i,pname_.i,param_.i)
glTexGeniv(coord_.i,pname_.i,params_.i)
glTexImage1D(target_.i,level_.i,internalformat_.i,width_.i,border_.i,format_.i,type_.i,pixels_.b)
glTexImage2D(target_.i,level_.i,internalformat_.i,width_.i,height_.i,border_.i,format_.i,type_.i,pixels_.b)
glTexParameterf(target_.i,pname_.i,param_.f)
glTexParameterfv(target_.i,pname_.i,params_.f)
glTexParameteri(target_.i,pname_.i,param_.i)
glTexParameteriv(target_.i,pname_.i,params_.i)
glTexSubImage1D(target_.i,level_.i,xoffset_.i,width_.i,format_.i,type_.i,pixels_.b)
glTexSubImage2D(target_.i,level_.i,xoffset_.i,yoffset_.i,width_.i,height_.i,format_.i,type_.i,pixels_.b)
glTranslated(x_.d,y_.d,z_.d)
glTranslatef(x_.f,y_.f,z_.f)
glVertex2d(x_.d,y_.d)
glVertex2dv(v_.d)
glVertex2f(x_.f,y_.f)
glVertex2fv(v_.f)
glVertex2i(x_.i,y_.i)
glVertex2iv(v_.i)
glVertex2s(x_.i,y_.i)
glVertex2sv(v_.i)
glVertex3d(x_.d,y_.d,z_.d)
glVertex3dv(v_.d)
glVertex3f(x_.f,y_.f,z_.f)
glVertex3fv(v_.f)
glVertex3i(x_.i,y_.i,z_.i)
glVertex3iv(v_.i)
glVertex3s(x_.i,y_.i,z_.i)
glVertex3sv(v_.i)
glVertex4d(x_.d,y_.d,z_.d,w_.d)
glVertex4dv(v_.d)
glVertex4f(x_.f,y_.f,z_.f,w_.f)
glVertex4fv(v_.f)
glVertex4i(x_.i,y_.i,z_.i,w_.i)
glVertex4iv(v_.i)
glVertex4s(x_.i,y_.i,z_.i,w_.i)
glVertex4sv(v_.i)
glVertexPointer(size_.i,type_.i,stride_.i,pointer_.b)
glViewport(x_.i,y_.i,width_.i,height_.i)
...
#GL_TEXTURE_CUBE_MAP_SEAMLESS_ARB=$884F
